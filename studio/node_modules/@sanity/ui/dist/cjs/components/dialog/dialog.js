...
const Dialog = (0, import_react.forwardRef)((props, ref) => {
  ...
  const labelId = `${id}_label`;
  return /* @__PURE__ */ import_react.default.createElement(import_utils.Portal, null, /* @__PURE__ */ import_react.default.createElement(Root, __assign(__assign({}, restProps), {
    $padding: padding,
    $position: position,
