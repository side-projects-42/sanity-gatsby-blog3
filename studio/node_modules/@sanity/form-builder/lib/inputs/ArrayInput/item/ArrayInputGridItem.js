...
class ArrayInputGridItem extends _react.default.PureComponent {
  ...
  componentDidMount() {
    ...
    if (value._key && (0, _focusUtils.hasFocusAtPath)(focusPath, value)) {
      this.focus();
    }
  }

  componentDidUpdate(prevProps) {
    var hadFocus = (0, _focusUtils.hasFocusAtPath)(prevProps.focusPath, prevProps.value);
    var hasFocus = (0, _focusUtils.hasFocusAtPath)(this.props.focusPath, this.props.value);
  ...
  renderItem() {
    ...
    var isEditingItem = (0, _focusUtils.hasFocusWithinPath)(focusPath, value);
    var memberType = this.getMemberType();
    ...
    return /*#__PURE__*/_react.default.createElement(_changeIndicators.ChangeIndicatorScope, {
      ...
      presence: isEditingItem ? _empty.EMPTY_ARRAY : presence,
      maxAvatars: 1
    }))), !readOnly && /*#__PURE__*/_react.default.createElement("div", {
