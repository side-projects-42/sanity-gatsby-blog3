...
export declare type Props = {
    ...
    focusPath: Path;
    readOnly?: boolean;
    onSearch: (query: string, type: ReferenceSchemaType, options: ReferenceFilterSearchOptions) => Observable<SearchHit[]>;
    onFocus: (path: Path) => void;
    getPreviewSnapshot: (reference: any, type: any) => Observable<PreviewSnapshot>;
