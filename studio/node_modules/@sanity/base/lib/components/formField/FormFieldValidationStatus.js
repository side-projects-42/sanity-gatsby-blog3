...
function FormFieldValidationStatus(props) {
  ...
  var statusColor = hasErrors ? _color.color.red[500].hex : _color.color.yellow[500].hex;
...
function FormFieldValidationStatusItem(props) {
  ...
  var statusColor = item.type === 'error' ? _color.color.red[500].hex : _color.color.yellow[500].hex;
