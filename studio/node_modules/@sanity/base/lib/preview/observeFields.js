...
function fetchAllDocumentPaths(selections) {
  ...
  return _versionedClient.versionedClient.observable.fetch((0, _optimizeQuery.toGradientQuery)(combinedSelections)).pipe((0, _operators.map)(result => (0, _optimizeQuery.reassemble)(result, combinedSelections)));
}
